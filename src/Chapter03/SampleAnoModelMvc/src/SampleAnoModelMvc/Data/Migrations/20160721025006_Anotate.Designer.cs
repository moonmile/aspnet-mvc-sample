...
using SampleAnoModelMvc.Data;

namespace SampleAnoModelMvc.Data.Migrations
{
    [DbContext(typeof(ApplicationDbContext))]
    [Migration("20160721025006_Anotate")]
    partial class Anotate
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("SampleAnoModelMvc.Models.ApplicationUser", b =>
                {
                    b.Property<string>("Id");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.EntityFrameworkCore.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("SampleAnoModelMvc.Models.ApplicationUser")
                        .WithMany("Claims")
