...
namespace HtmlHelperViewMvc.Data.Migrations
{
    [DbContext(typeof(ApplicationDbContext))]
    [Migration("20160725015852_init")]
    partial class init
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("HtmlHelperViewMvc.Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.EntityFrameworkCore.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("HtmlHelperViewMvc.Models.ApplicationUser")
                        .WithMany("Claims")
